  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-950 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">
            Equipamentos modernos e ambiente acolhedor para seu treino de
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Ambiente Completo para seu Treino
              </h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Nossa academia oferece um ambiente moderno e acolhedor, com
                equipamentos de qualidade para atender desde iniciantes até
                atletas avançados.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                Contamos com programas personalizados de emagrecimento e
                hipertrofia, sempre com acompanhamento profissional
                especializado.
              </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Programas e Treinos Personalizados!
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="border-2 border-gray-100">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-4">
                  Treinos personalizados focados na queima de gordura e melhoria
            ...
            <Card className="border-2 border-gray-100">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-4">
                  Treinos específicos para ganho de massa muscular e definição
                  corporal.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
